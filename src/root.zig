...
pub const eval_engine = @import("engine/eval_engine.zig");
...
pub const wasm_types = @import("app/wasm/types.zig");
pub const lifecycle = @import("runtime/lifecycle.zig");
pub const wasm_builtins = @import("app/wasm/builtins.zig");
pub const wit_parser = @import("app/wasm/wit_parser.zig");
