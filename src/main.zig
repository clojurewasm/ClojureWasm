...
const nrepl = @import("app/repl/nrepl.zig");
const line_editor = @import("app/repl/line_editor.zig");
...
const wasm_builtins = @import("app/wasm/builtins.zig");
const deps_mod = @import("app/deps.zig");
