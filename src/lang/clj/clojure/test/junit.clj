...
;;   this software.
;;
;;   clojure.test.junit — by Jason Sankey. Reproduced verbatim in ClojureWasm (a
;;   JUnit-XML reporter extending clojure.test's `report` multimethod, the same
;;   shape as the bundled clojure.test.tap); redistributed under EPL-2.0 per
;;   EPL-1.0 §7. ClojureWasm changes (c) the ClojureWasm authors.
