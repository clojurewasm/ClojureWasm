...
pub fn registerProtocols(allocator: Allocator, env: *Env) !void {
    ...
    const ep = try ns_core_protocols.createProtocol(allocator, ns, "EqualityPartition", ep_sigs, false);
    try ns_core_protocols.extendType(allocator, ep, "Object", &.{
    ...
    const diff_proto = try ns_core_protocols.createProtocol(allocator, ns, "Diff", diff_sigs, false);
    try ns_core_protocols.extendType(allocator, diff_proto, "Object", &.{
