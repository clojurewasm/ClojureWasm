...
pub fn registerProtocols(allocator: Allocator, env: *Env) !void {
    ...
    // Coercions protocol
    _ = try ns_core_protocols.createProtocol(allocator, io_ns, "Coercions", &.{
        .{ .name = "as-file", .arity = 1 },
        .{ .name = "as-url", .arity = 1 },
    }, false);
    // IOFactory protocol
    _ = try ns_core_protocols.createProtocol(allocator, io_ns, "IOFactory", &.{
...
pub fn makeDefaultStreamsImpl(allocator: Allocator) !Value {
...
// ============================================================
// Builtin table — these supplement io.zig's java_io_builtins
// ============================================================
