...
//! clojure.core.reducers — Simple Zig builtins for ForkJoin stubs and utilities.
//! Complex code (protocols, macros, reify, extend-type) stays as evalString in bootstrap.zig.
