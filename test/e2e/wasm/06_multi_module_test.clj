...
(def math-mod (wasm/load "src/app/wasm/testdata/20_math_export.wasm"))
...
(def app-mod (wasm/load "src/app/wasm/testdata/21_app_import.wasm"
...
(def base-mod (wasm/load "src/app/wasm/testdata/22_base.wasm"))
(def double (wasm/fn base-mod "double"))
(assert (= 10 (double 5)) "double(5) should be 10")

(def mid-mod (wasm/load "src/app/wasm/testdata/23_mid.wasm"
...
(def top-mod (wasm/load "src/app/wasm/testdata/24_top.wasm"
                        {:imports {"mid" mid-mod}}))
