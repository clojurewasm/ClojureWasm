;; Upstream: clojure/test/clojure/test_clojure/clojure_set.clj
;; Upstream lines: 224
;; CLJW markers: 3
...
;; CLJW: IllegalArgumentException → Exception (our arity error is Exception)
(deftest test-intersection
  ; at least one argument is needed
  (is (thrown? Exception (set/intersection)))
