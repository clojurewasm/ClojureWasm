...
| [24](#24-arraylist--stringhashmapunmanaged--array_hash_mapstring) | `ArrayList` / `StringHashMapUnmanaged` / `array_hash_map.String` | [24_arraylist_hashmap.zig](samples/24_arraylist_hashmap.zig)         |
