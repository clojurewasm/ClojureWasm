...
| #   | Task                                                 | Status  | Notes                                                                                                      |
|-----|------------------------------------------------------|---------|------------------------------------------------------------------------------------------------------------|
| 2.1 | Create Env (environment) in src/common/value/env.zig | pending | SS15.5: instantiated VM, no threadlocal. Env holds namespaces, is owned by VM instance. **Also: (D3a) migrate threadlocal to ErrorContext instance; (D3b) redesign Kind enum to Python-style categories** |
