...
| #     | Task                         | Archive                            | Notes                                      |
| ----- | ---------------------------- | ---------------------------------- | ------------------------------------------ |
| 14.11 | compat_test.yaml 拡張        | task_0121_compat_test_extension.md | clojure/test_clojure/\* 追跡セクション追加 |
| 14.12 | 優先度付きファイルリスト作成 | task_0122_test_file_priority.md    | 残りテストファイルの移植優先度決定         |
