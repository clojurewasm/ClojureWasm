...
| #   | Task                                                 | Archive | Notes                                                                                                      |
|-----|------------------------------------------------------|---------|------------------------------------------------------------------------------------------------------------|
| 2.1 | Create Env (environment) in src/common/env.zig       | --      | SS15.5: instantiated VM, no threadlocal. Env holds namespaces, is owned by VM instance. D3a (ErrorContext) completed. |
