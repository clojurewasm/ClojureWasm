...
| F117 | Cross-platform build (Phase 35X)             | Mac + Linux only (Windows excluded). Cross-compile cljw, verify `cljw build` on ELF, CI matrix. Blocked on Phase 35W (zware removal). Saved plan: `.claude/plans/phase35-cross-platform-saved.md`. |
