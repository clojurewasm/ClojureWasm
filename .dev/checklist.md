...
| F117 | Cross-platform build (Phase 35X)             | Mac + Linux only (Windows excluded). Cross-compile cljw, verify `cljw build` on ELF, CI matrix. Phase 35W complete (zware removed). Plan: `.dev/plan/phase35X-cross-platform.md`. |
