...
Adding a file under `.dev/decisions/` triggers the
`scripts/check_learning_doc.sh` gate. Pair every ADR with the corresponding
`docs/ja/NNNN-<slug>.md` learning doc.
