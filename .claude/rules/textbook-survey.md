...
ADR (`.dev/decisions/NNNN-promote-X.md`) or implement as a Wasm
...
| `docs/ja/NNNN-<slug>.md`                 | Chapter (digests notes)                           | Yes               |
| `.dev/decisions/NNNN-<slug>.md`          | ADR (load-bearing decisions surfaced from survey) | Yes               |
