...
2. **Per-concept chapter** (`docs/ja/NNNN-<slug>.md`) — written at a
...
Use `.claude/skills/code-learning-doc/TEMPLATE_TASK_NOTE.md`. The note
...
Filename: `docs/ja/NNNN-<slug>.md` — `NNNN` = next available 4-digit,
`<slug>` = kebab-case (English-preferred).
