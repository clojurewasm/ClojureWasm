...
- `docs/ja/NNNN-*.md`: 200–400 lines (story-sized)
...
# - .dev/decisions/0000-template.md only  → should NOT trigger (template)
# - .dev/decisions/0001-foo.md only       → SHOULD trigger
# - src/main.zig + docs/ja/9999-x.md      → SHOULD block (Rule 1)
```
